                  ...
                  <tbody>
                    @foreach($customers as $customer)
                      <tr>
                          ...
                          <td>
                            <a href="{{ route('customer.edit',$customer->id) }}" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#viewModal{{ $customer->id }}">Edit</a>
                            ...
                            <a href="{{ route('customer.delete',['id'=>$customer->id]) }}"  class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleted-modal{{ $customer->id }}">Delete</a>

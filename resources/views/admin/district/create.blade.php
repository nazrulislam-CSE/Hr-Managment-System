            ...
            <div class="row m-4">
              <div class="form-group col-md-12">
               ...
               <select name="division_id" class="form-control"  >
                  ...
                  @foreach($division as $key=>$dist)
                  <option value="{{ $dist->id}}">{{ $dist->division_name }}</option>
                  @endforeach
               </select>
              </div>
           </div>  
            ...
            <div class="row m-4">
              <div class="form-group col-md-12">
                ...
                @error('district_name')
                  <span class="text-danger">{{ $message }}</span>
                @enderror
                <input type="text" name="district_name" id="district_name" class="form-control " value="" >
              </div>
           </div>  
